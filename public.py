...
bot = telebot.TeleBot('7598436920:AAHPGLQfzkdNAT7SSqZzK_gVGktnSIanNz0')

# Admin user IDs
admin_id = ["1388575885"]

# Group and channel details
GROUP_IDS = ["-1002692909259"]  # List of allowed group IDs (replace second ID with your actual second group ID)
CHANNEL_USERNAME = "@Prof.X"
    ...
    try:
        ...
        if user_status not in ['member', 'administrator', 'creator']:
            bot.reply_to(message, f"❌ **𝘽𝙃𝘼𝙄, 𝙔𝙊𝙐 𝙈𝙐𝙎𝙏 𝙅𝙊𝙄𝙉 𝙊𝙐𝙍 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙁𝙄𝙍𝙎𝙏!**\n"
                                  f"🔗 **𝙅𝙤𝙞𝙣 𝙃𝙚𝙧𝙚:** [Click Here](https://t.me/+9l_F7PFWvHIyZDI1)")
            return  
...
👉 [𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈 𝙂𝙍𝙊𝙐𝙋](https://t.me/+9l_F7PFWvHIyZDI1) 🚀🔥"""
